...
if (isset($_GET['id'])) {
    ...
    $sql_classificacao = "
        SELECT e.nome_equipe,
               ...
               SUM(r.gols_equipe_casa) + SUM(r.gols_equipe_fora) AS gols_marcados,
               SUM(r.gols_equipe_casa) - SUM(r.gols_equipe_fora) AS saldo_gols
        FROM equipes e
...
<head>
    ...
    <title>Classificação - <?= htmlspecialchars($nome_torneio); ?></title>
</head>
<body>
    ...
    <!-- Conteúdo Principal -->
    <div class="container">
        <h3>Classificação - <?= htmlspecialchars($nome_torneio); ?></h3>
            ...
            <tbody>
                ...
                while ($row = $classificacao->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($row['saldo_gols']); ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
