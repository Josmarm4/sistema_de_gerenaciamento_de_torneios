...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO inscricoes (id_torneio, id_equipe) VALUES ('$id_torneio', '$id_equipe')";
    if ($link->query($sql) === TRUE) {
        $mensagem = "Inscrição realizada com sucesso!";
    } else {
        $mensagem = "Erro ao realizar inscrição: " . $link->error;
    }
}
?>
...
<head>
    ...
    <title>Inscrição em Torneios</title>
</head>
<body>
    ...
    <div class="container-form mt-5">
        <div class="left-panel text-center">
            <h2>Participe dos Torneios</h2>
            <p>Inscreva sua equipe nos torneios disponíveis.</p>
        </div>

        <div class="right-panel">
            <h3>Inscrição em Torneios</h3>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id_equipe" name="id_equipe" placeholder="Informe o ID da equipe" required>
                </div>
                <button type="submit" class="btn btn-custom btn-block">Inscrever</button>
            </form>
        </div>
    </div>
